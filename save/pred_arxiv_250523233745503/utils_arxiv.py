...
def build_domains(datasets, meta_vars, device):
    train_idx = np.array([1, 3, 4, 5, 9, 14, 18, 20, 22, 23, 26, 28, 31, 32, 33, 39, 40, 41, 42, 43, 46, 47, 48, 49, 50, 51, 53, 55, 56, 59, 62, 64, 66, 68, 69, 71, 72, 74, 76, 78])
...
param_size, param_shapes = build_mlp_layers(384, 50, 10)
